...
class OPF:
        ...
        def parse_address_block(block):
            ...
            if not state:
                ...
                if re.search('Mumbai', address, flags=re.IGNORECASE):
                    state = 'Maharashtra'
                elif (re.search('tamil', address, flags=re.IGNORECASE) and re.search('nadu', address,
                                                                                     flags=re.IGNORECASE)) or re.search(
                        'chennai', address, flags=re.IGNORECASE):
    ...
    def parse_sales_data(self, sales_table):
        ...
        while True:
            ...
            try:
                (i for i in sr_no if i.isdigit()).__next__()
            except:
        ...
        for i in sales_table:
            for index, j in enumerate(i):
                ...
                if 'CGST' in j:
                    ...
                    if index < len(i) - 1:
                        freight_value = self.position_insensitive_strip(i[index + 1], ' ,:\'"')
                        if freight_value and all([e.isdigit() for e in freight_value]) and int(freight_value) != 0:
                            result.update(freight=i[index + 1])
                        else:
                            result.update(freight='')
        try:
            result['freight']
        except:
            result['freight'] = '0'
...
rt_1 = [62400100, 62400100, 78000100, 78000200, 46800000, 62400200, 15600000, 31200000, 31200100, 62400100, 31200100,
        31200000, 46800100, 109200200, 124800200, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100,
        31200000, 31200100, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100,
        31200000, 62400200, 15600000, 46800100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000,
        31200100, 31200100, 15600000, 31200000, 31200100, 46800100, 31200000, 31200100, 31200000, 62400200, 31200000,
        46800100, 31200000, 31200100, 31200100, 31200000, 46800100, 31200000, 31200100, 31200100, 31200000, 31200100,
        31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 46800100, 31200100, 62400100, 46800100,
        31200000, 62400100, 46800100, 31200100, 31200000, 46800100, 31200100, 31200000, 15600100, 31200000, 124800200,
        31200100, 46800100, 31200000, 46800100, 46800100, 31200000, 46800100, 62400100, 46800100, 46800100, 46800100,
        46800100, 62400100, 46800100, 46800000, 46800100, 62400100, 46800100, 46800100, 62400100, 46800100, 46800100,
        46800000, 62400200, 46800000, 46800100, 62400100, 46800100, 46800100, 46800100, 46800100, 46800000, 46800100,
        46800100, 46800100, 46800100, 46800100, 46800000, 46800100, 46800100, 31200100, 46800000, 31200100, 31200000,
        31200100, 46800100, 46800100, 62400100, 46800100, 46800000, 46800100, 31200100]
rt_2 = [31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 15600100, 31200000, 31200100, 46800000, 31200100,
        31200100, 46800000, 93600200, 109200200, 31200100, 31200000, 31200100, 31200000, 46800100, 31200100, 31200000,
        31200100, 15600000, 31200000, 31200100, 31200100, 31200000, 31200100, 46800000, 31200100, 15600000, 46800100,
        31200100, 46800000, 31200100, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000,
        31200100, 31200100, 31200000, 15600000, 31200100, 46800100, 31200000, 31200100, 31200000, 62400100, 31200100,
        46800100, 31200000, 31200100, 31200000, 31200100, 46800100, 31200000, 31200100, 31200000, 31200100, 31200100,
        31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 46800100, 15600000, 78000200, 31200000,
        46800100, 46800100, 46800100, 31200000, 46800100, 31200100, 31200000, 31200100, 31200000, 15600100, 109200200,
        46800000, 31200100, 46800100, 46800100, 31200000, 46800100, 31200100, 62400100, 31200000, 46800100, 46800100,
        62400100, 46800100, 62400100, 46800100, 46800100, 46800000, 46800100, 46800100, 78000100, 31200100, 46800100,
        46800100, 62400100, 46800000, 46800100, 46800100, 46800100, 46800100, 46800100, 62400100, 46800000, 46800100,
        31200100, 46800100, 46800000, 46800100, 46800100, 62400100, 31200100, 31200000, 46800100, 31200100, 46800100,
        15600000, 46800100, 62400100, 46800100, 46800000, 46800100, 46800100, 46800100]
rt_3 = [31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 46800100, 15600000,
        15600100, 46800000, 93600200, 109200200, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100,
        31200000, 31200100, 31200100, 15600000, 31200000, 31200100, 31200000, 46800100, 31200100, 31200000, 31200100,
        31200000, 46800100, 31200100, 31200000, 31200100, 46800100, 15600000, 31200100, 31200000, 31200100, 31200000,
        31200100, 31200000, 31200100, 15600000, 31200100, 46800100, 31200000, 31200100, 31200000, 62400100, 31200100,
        46800100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 31200000, 31200100, 31200100, 31200000,
        46800100, 31200000, 15600100, 46800100, 15600000, 31200000, 15600000, 46800100, 31200000, 62400100, 31200100,
        31200100, 46800100, 46800000, 31200100, 46800100, 31200000, 31200100, 31200000, 15600100, 31200000, 109200200,
        31200100, 46800100, 31200000, 46800100, 46800100, 31200000, 46800100, 46800100, 46800100, 46800100, 46800000,
        46800100, 62400100, 46800100, 46800100, 46800100, 46800100, 46800000, 62400200, 62400100, 31200000, 46800100,
        46800100, 62400100, 46800100, 46800100, 46800000, 46800100, 46800100, 46800100, 62400100, 31200000, 46800100,
        46800100, 46800100, 46800100, 46800100, 46800000, 46800100, 31200100, 46800100, 31200000, 31200100, 46800100,
        15600000, 46800100, 62400100, 46800100, 46800000, 46800100, 46800100, 46800100]
